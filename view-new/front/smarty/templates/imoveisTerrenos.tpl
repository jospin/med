<div class="title_featured">
	<h2 class="feature-title">Terrenos</h2>
</div>
<div class="row">
	<div class="col-md-9">
		<div class="row">
		{foreach item=i from=$imoveis}
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail-feature">
					...
					<dt>Valor:</dt>
					<dd>{if empty($i->imovel->valor) || $i->imovel->valor <=0}-{else}{$i->imovel->valor}{/if}</dd>
				  </dl>
		...
		<ul class="list-group">
			{foreach item=filtro from=$imoveisFiltro}
				<li class="list-group-item">
					...
					<a href="imoveisTerrenos.php?id_praia={$filtro->id_praia}">
