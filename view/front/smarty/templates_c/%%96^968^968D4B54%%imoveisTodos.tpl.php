<?php /* Smarty version 2.6.26, created on 2018-01-17 01:38:57
         compiled from imoveisTodos.tpl */ ?>
...
<?php endif; ?></li>
						<li><span class="left">Capacidade:</span> <?php if (empty ( $this->_tpl_vars['f']->imovel->capacidade_pessoas )): ?>-<?php else: ?><?php echo $this->_tpl_vars['f']->imovel->capacidade_pessoas; ?>
<?php endif; ?></li>
						</a>
					  </ul>
					  </a>				
...
?>
									<li class='li_140'><a href="imoveisTodos.php?id_praia=<?php echo $this->_tpl_vars['filtro']->id_praia; ?>
