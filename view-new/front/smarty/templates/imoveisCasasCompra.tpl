<div class="title_featured">
	<h2 class="feature-title">Casas à venda</h2>
</div>
<div class="row">
	<div class="col-md-9">
		<div class="row">
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail-feature">
					...
					<dl class="dl-horizontal">
						...
						<dt>Suíte</dt>
						<dd>
							{if empty($i->imovelDetalhes.suites.valor)}-{else}{$i->imovelDetalhes.suites.valor}{/if}
						</dd>
					  	<dt>Referência:</dt><dd>{$i->imovel->pagina_caderno}</dd>
						<dt>Piscina:</dt><dd>{if empty($i->imovelDetalhes.piscina.valor)}-{else}{$i->imovelDetalhes.piscina.valor}{/if}</dd>
						<dt>Capacidade:</dt><dd>{if empty($i->imovel->capacidade_pessoas)}-{else}{$i->imovel->capacidade_pessoas pessoas}{/if}</dd>
					</dl>
		...
		<ul class="list-group">
			{foreach item=filtro from=$imoveisFiltro}
				<li class="list-group-item">
					...
					<a href="imoveisCasasCompra.php?id_praia={$filtro->id_praia}">
