			...
			<ul class="four_column_properties">
					...
					<li><a href="imovel.php?id_imovel={$i->imovel->id_imovel}">
					  ...
					  <ul class="box_text">
						...
						<li><span class="left">Valor diária:</span> R$ {if empty($i->imovel->valor) || $i->imovel->valor <=0}-{else}{$i->imovel->valor|number_format:2:",":"."}{/if}</li>
						</a>
					  </ul>
					  </a>				
					</li>
						...
						<ul>				
							<li class="widget-container widget_categories">
								...
								<ul>
									...
									<li class='li_140'><a href="imoveisCasasTemporada.php?id_praia={$filtro->id_praia}">{$filtro->praia} ({$filtro->filtro})</a></li>
