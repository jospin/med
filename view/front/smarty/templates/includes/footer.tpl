<div id="footer-left">
				...
				<div id="footer-right">
					...
					<div><input type="text" class="inputbox" value="Enter your email here..." onblur="{literal}if (this.value == ''){this.value = 'Enter your email here...'; }" onfocus="if (this.value == 'Enter your email here...') {this.value = ''; }{/literal}"/><br />
<input type="submit" name="submit" class="button" value="subscribe"/></div>
					</form>
				</div><!-- end #footer-right -->
			</div><!-- end #footer -->
			<div class="clear"></div>
			<div id="copyright">Copyright © 2006 <a href="#">Medeiros Imóveis</a>. All Rights Reserved</div>
