...
<div id="content" class="full_85">
			<h2 class="underline">Casas para locação</h2>
...
<?php endif; ?></li>
						<li><span class="left">Valor mensal:</span> R$ <?php if (empty ( $this->_tpl_vars['i']->imovel->valor ) || $this->_tpl_vars['i']->imovel->valor <= 0): ?>-<?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['i']->imovel->valor)) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
<?php endif; ?></li>
						</a>
					  </ul>
					  </a>				
...
?>
									<li class='li_140'><a href="imoveisCasasAluguel.php?id_praia=<?php echo $this->_tpl_vars['filtro']->id_praia; ?>
