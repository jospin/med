...
<div id="footer-left">
				...
				<div id="footer-right">
					...
					<div><input type="text" class="inputbox" value="Enter your email here..." onblur="<?php echo 'if (this.value == \'\'){this.value = \'Enter your email here...\'; }" onfocus="if (this.value == \'Enter your email here...\') {this.value = \'\'; }'; ?>
"/><br />
